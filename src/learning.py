...
def learn():
    ...
    with col2:
        vAR_Category_Learning = ['Select','Summarize','Like a 5th Grader','Plagarism Checker','X Teacher','Writing Tutor','Career Counsllor','Translator','Traval Guide','Personal Trainer','Finacial Assistant']
    ...
    elif vAR_input == 'Like a 5th Grader':
        with col1:
            st.write('# ')
            st.write('# ')
            st.markdown("<p style='text-align: left; color: black; font-size:20px;'><span style='font-weight: bold'>Example Prompt</span></p>", unsafe_allow_html=True)
