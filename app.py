...
st.markdown("<p style='text-align: center; color: blue;margin-top: -15px ;font-size:20px;'><span style='font-weight: bold'></span>Chatgpt prompt</p>", unsafe_allow_html=True)
