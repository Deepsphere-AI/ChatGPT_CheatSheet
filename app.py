...
with imcol3:
    st.write("")
st.markdown("<p style='text-align: center; color: black; margin-top: -20px ; font-size:25px;'><span style='font-weight: bold'>ChatGPT Application: </span>Content Classifier</p>", unsafe_allow_html=True)
...
st.markdown("<p style='text-align: center; color: blue;margin-top: -15px ;font-size:20px;'><span style='font-weight: bold'></span>Classify Whether a Given Content is Written by Human or AI</p>", unsafe_allow_html=True)
